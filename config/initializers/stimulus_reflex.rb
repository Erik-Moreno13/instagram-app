...
StimulusReflex.configure do |config|
  ...
  # eg. if your connection is `identified_by :current_user` and your User model has an email attribute, you can access r.email (it will display `-` if the users isn't logged in)
